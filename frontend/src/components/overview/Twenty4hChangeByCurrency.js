...
const Twenty4hChangeByCurrency = ({ cryptoCurrencies, currencyName }) => {
  ...
  return (
    <div className="twenty_four_hour_container">
      <div className="crypto_24h_change">
        price: {get24hourChange().current_price.toFixed(2)} &euro;
      </div>
      <div
        style={{
      ...
      >
        24h change: {get24hourChange().price_change_24h.toFixed(2)} &euro;
      </div>
      <div className="crypto_24h_change">
        24h max: {get24hourChange().max_24h.toFixed(2)} &euro;
      </div>
      <div className="crypto_24h_change">
        24h min: {get24hourChange().min_24h.toFixed(2)} &euro;
      </div>
    </div>
  );
};
